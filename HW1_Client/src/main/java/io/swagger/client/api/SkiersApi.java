...
public class SkiersApi {
     ...
     * @param resort resort to filter by (required)
     * @param season season to filter by, optional (optional)
     * @return List&lt;SkierVertical&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public List<SkierVertical> getSkierResortTotals(Integer skierID, List<String> resort, List<String> season) throws ApiException {
        ApiResponse<List<SkierVertical>> resp = getSkierResortTotalsWithHttpInfo(skierID, resort, season);
        return resp.getData();
    }
     ...
     * @param resort resort to filter by (required)
     * @param season season to filter by, optional (optional)
     * @return ApiResponse&lt;List&lt;SkierVertical&gt;&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<List<SkierVertical>> getSkierResortTotalsWithHttpInfo(Integer skierID, List<String> resort, List<String> season) throws ApiException {
        com.squareup.okhttp.Call call = getSkierResortTotalsValidateBeforeCall(skierID, resort, season, null, null);
        Type localVarReturnType = new TypeToken<List<SkierVertical>>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getSkierResortTotalsAsync(Integer skierID, List<String> resort, List<String> season, final ApiCallback<List<SkierVertical>> callback) throws ApiException {
